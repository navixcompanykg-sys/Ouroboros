...
// лет. Пресеты админ-панели (client/admin-panel.js) доходят лишь до ×10000 от
// игровой (нужно для видимого движения звёзд на карте сектора — на ×120 даже
// самая быстрая орбита проходит клеть за ~3 минуты); запас всё равно остаётся
// огромным, для ручных стресс-прогонов оборота сектора.
const maxSpeed = 240
